...
global_url = "https://api.coinmarketcap.com/v2/global/" #"https://pro-api.coinmarketcap.com"
...
print("The global cap of all crytptos is "+ global_cap_string + " and the 24h global volume is " + global_volume_string + '.')
